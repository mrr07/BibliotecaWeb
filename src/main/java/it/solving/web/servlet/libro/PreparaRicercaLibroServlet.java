...
/**
 * Servlet implementation class PreparaRicercaLibroServlet
 */
@WebServlet("/PreparaRicercaLibroServlet")
public class PreparaRicercaLibroServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PreparaRicercaLibroServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("ricercaLibro.jsp").forward(request, response);
		}
